...
def pre_process_electr_gen(root, years, provinces):
    """
    Creates input/output table for electr generators from CODERS
    """
    print('Creating input/output sheets for electricity generators')
    data = pd.read_csv('electr_gen.csv',index_col=0)
