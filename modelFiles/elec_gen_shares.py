...
def generation_shares(msgSC):
    ...
    lc_2025 = make_share_df("powerplant_low-carbon", '2025', 0.5412) # pakistan economic survey 23-24
    ...
    fossil_25 = make_share_df('powerplant_fossil', '2025', 0.4588) # pakistan economic survey 23-24
    fossil_30 = make_share_df('powerplant_fossil', '2030', 0.3400) # igcep 24-34
    fossil_35 = make_share_df('powerplant_fossil', '2035', 0.2700) # igcep 24-34
    ...
    hydro_2025 = make_share_df("hydro_total", '2025', 0.26) # pakistan economic survey 23-24
...
def make_share_df(shares, year_act, value):
    return make_df(
        "share_commodity_lo",
        shares=shares,
        node_share="R12_PAK",
