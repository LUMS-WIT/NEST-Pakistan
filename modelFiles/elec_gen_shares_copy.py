...
def generation_shares(msgSC):
    ...
    elec_gen_remove = elec_gen[elec_gen["technology"].str.contains("scr|hpl|htfc|sm._ppl|curtailment|cv|solar_pv_ppl|stor_ppl|geo_ppl|wind_ppl|wind_ppf|hydro", regex=True)] ################################################# nuc
    ...
    ppl_total = msgSC.set("cat_tec", {"type_tec":["powerplant_low-carbon", "powerplant_fossil", "powerplant_hydro", ]})["technology"] ################################################# "powerplant_nuclear"
    ...
    lc_2025 = share_commodity_lo_df("powerplant_low-carbon", '2025', 0.20) # pakistan economic survey 24-25
    ...
    hydro_2025 = share_commodity_lo_df("powerplant_hydro", '2025', 0.30) # pakistan economic survey 23-24
